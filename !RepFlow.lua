...
local changelogEntries = {
    {
        version = "3.6 | Premium",
        description = " - Оптимизировано количество сообщений в чате: объединены начальные уведомления, добавлена настройка для их отключения.\n - Добавлены кликабельные ссылки на blast.hk и GitHub-репозиторий в меню 'Информация'.\n  - Исправлены потенциальные проблемы с сохранением настроек при перемещении окна.\n  - Улучшена стабильность при обновлении зависимостей из репозитория."
    },
    {
        version = "3.5 | Premium",
