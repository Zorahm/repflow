...
local script_vers = 3.61           -- Текущая версия скрипта (числовая)
local script_vers_text = "3.61"    -- Текущая версия для отображения пользователю
