...
- **Информационное окно**: отображение статуса ловли, времени работы и количества принятых репортов.
...
### Интерфейс
- **Флудер**: Настройка интервала и режима работы.
- **Настройки**: Основные параметры и управление окном.
- **Информация**: Сведения об авторе, версии и функционале.
